...
namespace PostsByMarko.FrontendTests.Tests
{
    ...
    public class AdminTests : IAsyncLifetime
    {
        ...
        private readonly string ownerEmail = TestingConstants.OWNER_EMAIL;
        ...
        public async Task should_toggle_user_admin_privileges()
        {
            ...
            var emailsNotToToggle = new List<string> { testAdminEmail, ownerEmail, testUserEmail };
        ...
        public async Task should_delete_a_user()
        {
            ...
            var emailsNotToDelete = new List<string> { testAdminEmail, ownerEmail, testUserEmail };
            var emails = await adminDashboardPage.GetEmails();
